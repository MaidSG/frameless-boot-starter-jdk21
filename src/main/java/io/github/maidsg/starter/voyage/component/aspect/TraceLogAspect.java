...
import io.github.maidsg.starter.voyage.annotation.Traceable;
import io.github.maidsg.starter.voyage.dao.LogFileDataSource;
import io.github.maidsg.starter.voyage.enums.LogLevelEnum;
import io.github.maidsg.starter.voyage.interfaces.LogBackDataSource;
...
public class TraceLogAspect extends BaseAspect{
    ...
    @Pointcut("@annotation(io.github.maidsg.starter.voyage.annotation.Traceable)")
