...
import io.github.maidsg.starter.voyage.annotation.desensitization.DecodeData;
import io.github.maidsg.starter.voyage.annotation.desensitization.EncodeData;
import io.github.maidsg.starter.voyage.util.DataDesensitizationUtil;
...
public class DataDesensitizationAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("@annotation(io.github.maidsg.starter.voyage.annotation.desensitization.EncodeData) || @annotation(io.github.maidsg.starter.voyage.annotation.desensitization.DecodeData)")
